...
.then(response => {
    for (let repository of response) {
        ...
        const element = `<article class="bg-gradient-to-br from-white/10 to-white/5 rounded-[1.25rem] overflow-clip flex flex-col h-full justify-between">
        <div
        ...
        <div class="lg:p-10 md:p-6 p-5 flex flex-col justify-between grow">
          <div>
          ...
          <div class="flex flex-col flex-wrap md:flex-row gap-4 md:text-xl text-base">
            <a href="${homepage}" 
                target="blank"
